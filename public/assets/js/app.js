$(document).on('turbolinks:load', function () {
    !function (s) {
        ...
        s(document).ready(function () {
            var e;
            0 < s("#sidebar-menu").length && 0 < s("#sidebar-menu .mm-active .active").length && (
                300 < (e = s("#sidebar-menu .mm-active .active").offset().top) && (e -= 300, s(".vertical-menu .simplebar-content-wrapper").animate({
                    scrollTop: e
                }, "slow"))
            )
        }),
            ...
            document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement
                ...
                : document.documentElement.requestFullscreen
                    ...
                    : document.documentElement.mozRequestFullScreen
                        ...
                        : document.documentElement.webkitRequestFullscreen && document
                            .documentElement
        ...
        s(document).on("click", "body", function (e) {
            0 < s(e.target)
                ...
                .length || s("body").removeClass("right-bar-enabled")
        }),
        function () {
        ...
        s(".table-check .form-check-input").change(function () {
            s(".table-check .form-check-input:checked").length == s(
    ...
    isRefresh = true; // Setel isRefresh ke true setelah halaman dimuat
});