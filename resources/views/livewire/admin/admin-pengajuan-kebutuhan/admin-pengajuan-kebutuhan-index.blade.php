                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                <h5 class="text-truncate font-size-15"><a href="javascript: void(0);" class="text-dark">{{ $p->nama_barang }} (<i>{{ $p->jenis }}</i>)</a></h5>
                                ...
                                <a href="/aproval-pengajuan/detail/{{ $p->id }}" class="btn btn-primary btn-sm"><i class="bx bx-detail"></i> Detail</a>
                    ...
                    <div class="px-4 py-3 border-top">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item me-3">
                                <li class="list-inline-item me-3">
                                    <i class= "bx bx-map me-1"></i> {{ $p->lokasi->nama_lokasi }}
                                </li>
                            </li>
                        </ul>
                    </div>
