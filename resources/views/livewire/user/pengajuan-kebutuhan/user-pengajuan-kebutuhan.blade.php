                ...
                <div class="row">
                            ...
                            <table class="table table-hover dt-responsive nowrap table-sm" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <br> @if ($p->status == 'tolak' || $p->status == 'terima')            
                                            <a href="/pengajuan-kebutuhan/detail/{{ $p->id }}" class="btn btn-primary btn-sm"> Detail </a>
                                        @endif 
                                        </td>
                                    </tr>
                                        ...
                                        <tr colspan="3">
                                            <td  colspan="7">
                                                <div class="border text-center align-middle p-5">
                                                    <h5>Belum ada Produk Pengajuan Kebutuhan</h5>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
                    ...
                    <div class="col-md-3">
                        <div class="d-grid gap-2">
                            <button   onclick="window.location.href='/pengajuan-kebutuhan-tambah'" type="button" class="btn btn-success waves-effect waves-light"><i class="bx bx-upload"></i> Buat Pengajuan Kebutuhan</button>
                        </div>
                       @if ($produk->count())
