            ...
            <div class="card-body">
                                ...
                                <div class="col-md-7 offset-md-1 d-print-none col-sm-9 col-8">
                                    <div class="tab-content" id="v-pills-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="product-2" role="tabpanel" aria-labelledby="product-2-tab">
                                            <div>
                                                <img onclick="window.location.href='/print-QR/{{ $produk->id }}'" id="qr"  src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(300)->generate('Kode Produk : '.$produk->codeprodukid .' ,Nama barang : '.$produk->produk->nama_barang .'  Lokasi : '.$produk->lokasi->nama_lokasi .' ,Tanggal Kadaluarsa : '.$tgl_kadaluarsa.' ,Tanggal pembelian : '.$produk->tgl_pembelian->format('d F Y') . ', Merk : '.$produk->produk->merk .' , Kategori : '.$produk->produk->kategori->nama_kategori .' , Jumlah Awal : '.$produk->jumlah_awal .' unit , Links : '.Request::url() .',')) !!} "
                ...
                <div class="mt-5 d-print-none">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <a href="/daftar-barang" class="btn btn-sm btn-secondary"> <i class="bx bx-left-arrow-alt"></i> kembali</a>
                    </div>
                </div>
                <!-- end Specifications -->
            </div>
