                    ...
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1 align-self-center">
                            <div class="text-muted">
                                ...
                                <p class="mb-0">{{ $user->status_medis }}</p>
                            </div>
                        </div>
                        <div class="">
                            <div class="flex-0">
                                ...
                                <form wire:submit.prevent="EditProfile" enctype="multipart/form-data">
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <div class="mb-3">
                                                <label for="status_medis">Status Medis</label>
                                                <select type="text"  id="status_medis" wire:model="user.status_medis" class="form-control @error('user.status_medis') is-invalid @enderror">
                                                    <option value="perawat">Perawat</option>
                                                    <option value="bidan">Bidan</option>
                                                </select>    @error('user.status_medis') <span class="invalid-feedback">{{ $message }}</span> @enderror
                                            </div>
