            ...
            <div class="card rtc shadow-lg" style="min-height: 400px;">
                <div class="card-body">
                    ...
                    <div class="row px-5 border shadow-sm ">
                        <form wire:submit.prevent="EditProfile" class="p-3" enctype="multipart/form-data">
                            <div class="row mt-3">
                                <div class="col-md-5">
                                    <div class="text-center">
                                        <div class="profile-container">
                                            ...
                                            @else
                                                <img class="profile-image rounded-circle mx-auto border shadow-md"  src="/assets/profile/avatar-umum.jpg" alt="Foto Profil">
                                            @endif
                                            <div class="edit-icon">
                                ...
                                <div class="col-md-7">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select select2" id="kategori" wire:model="status" class="form-control @error('status') is-invalid @enderror">
                                            @foreach($role as $name_role)
                                                <option value="{{ $name_role }}"> {{ $name_role }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="text-muted">kosongkan untuk default password : digidukun.com</p>
                                    </div>
