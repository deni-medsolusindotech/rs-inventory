<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        <div class="mb-3">
            ...
            <x-text-input placeholder="6285759200796" id="nomor_hp" name="nomor_hp" type="text" class="mt-1 block w-full" :value="old('nomor_hp', $user->nomor_hp)" required autofocus autocomplete="nomor_hp" />
            <x-input-error class="mt-2" :messages="$errors->get('nomor_hp')" />
        </div>
        <div class="mb-3">
            <x-input-label for="avatar" :value="__('Foto Profile')" />
            <x-text-input id="avatar" name="profile_image" type="file" class="mt-1 block w-full"/>
